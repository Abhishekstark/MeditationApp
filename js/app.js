...
//TOTAL LENGTH OF THE PATH (PERIMETER OF RECTANGLE)
const pathLength = path.getTotalLength();
// SET LENGTH OF DASH TO pathLength
...
//STROKE DASHOFFSET IS PROPORTIONAL TO portionPlayed
...
//IF min/sec is a single digit . we add zero before that
